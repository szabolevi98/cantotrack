...
use CantoTrack\Controller\TemplateController;
...
$router->post('/dashboard/gadgets/{id}', static fn($id) => (new DashboardController())->updateGadget((int) $id));
$router->post('/dashboard/gadgets/{id}/delete', static fn($id) => (new DashboardController())->removeGadget((int) $id));
$router->post('/dashboard/builtins', static fn() => (new DashboardController())->addBuiltin());
$router->post('/dashboard/layout', static fn() => (new DashboardController())->arrange());
$router->post('/dashboard/reset', static fn() => (new DashboardController())->reset());
...
$router->get('/projects/{id}/templates', static fn($id) => (new TemplateController())->index((int) $id));
$router->post('/projects/{id}/templates', static fn($id) => (new TemplateController())->create((int) $id));
$router->post('/templates/{id}', static fn($id) => (new TemplateController())->update((int) $id));
$router->post('/templates/{id}/delete', static fn($id) => (new TemplateController())->delete((int) $id));
$router->post('/projects/{id}/recurring', static fn($id) => (new TemplateController())->repeat((int) $id));
$router->post('/recurring/{id}/toggle', static fn($id) => (new TemplateController())->toggle((int) $id));
$router->post('/recurring/{id}/delete', static fn($id) => (new TemplateController())->deleteRecurring((int) $id));
$router->post('/recurring/{id}/now', static fn($id) => (new TemplateController())->makeNow((int) $id));
...
$router->post('/pages/{id}/attachments', static fn($id) => (new AttachmentController())->uploadToPage((int) $id));
$router->post('/pages/{id}/comments', static fn($id) => (new PageController())->comment((int) $id));
$router->post('/page-comments/{id}/delete', static fn($id) => (new PageController())->deleteComment((int) $id));
...
$router->get('/clients', static fn() => (new ClientController())->index());
$router->post('/clients', static fn() => (new ClientController())->create());
$router->get('/clients/{id}', static fn($id) => (new ClientController())->show((int) $id));
$router->post('/clients/{id}', static fn($id) => (new ClientController())->update((int) $id));
$router->post('/clients/{id}/delete', static fn($id) => (new ClientController())->delete((int) $id));
